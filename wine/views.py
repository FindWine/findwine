...
from django.db.models import Avg, Max, Min, Func, Case, When, Value, URLField, DecimalField, FloatField, Q, F
from django.db.models.functions import Cast
from django.http import HttpResponse, HttpResponseRedirect, HttpRequest, QueryDict, JsonResponse
...
from .models import WineVintage, MerchantWine, WineAward, Producer, SubCategory
from .forms import BasicSearchForm, AdvancedSearchForm

## CLEAN OUT UNUSED ONES ABOVE
...
def search(request):
        ...
        if request.method == 'POST':
                ...
                if form.is_valid():
                        ...
                        sub_category = form.cleaned_data['sub_category'] #SubCategory.objects.filter(category__name__exact=category)
...
class ResultsView(generic.ListView):
		...
		#1 Add country
                ...
                results_list = results_list.annotate(rating=Round(Avg('wine_vintage__wineaward__award__tier__normalised_rating')))
