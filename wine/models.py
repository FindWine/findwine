...
class WineVintage(models.Model):
	...
	image_label_horizontal = models.ImageField(upload_to = 'images/winevintage_label_horizontal/', null=True, blank=True)
	...
	def rating(self):
                ...
                return WineAward.objects.filter(wine_vintage=self).aggregate(avg_rating=Avg('award__tier__normalised_rating')) 
...
class Merchant(models.Model):
	...
	sales_commission_percentage = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=2, help_text="Full percentage e.g. 8 for 8%")
...
class WineGrape(models.Model):
	...
	percentage = models.DecimalField(null=True, blank=True, max_digits=5, decimal_places=2, help_text="Percentage value eg. '69.0' for 69%")
