...
var WineList = exports.WineList = function (_React$Component) {
    ...
    value: function render() {
      if (this.props.isLoading) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: constructImagePath('wine/images/other/loading.gif'), alt: 'loading...' }),
        ...
        return _react2.default.createElement(
          'div',
          { className: 'findwine_vintage-table' },
          this.props.wines.map(function (winevintage, index) {
            var imageUrl = winevintage.image_url ? winevintage.image_url : constructImagePath('wine/images/other/placeholder.jpg');
            return _react2.default.createElement(
              'a',
              { href: winevintage.details_url, key: index },
              _react2.default.createElement(
                'div',
                { className: 'findwine_search-results' },
                _react2.default.createElement(
                  'div',
                  { className: 'findwine_search-result--table' },
                  _react2.default.createElement(
                    'div',
                    { className: 'findwine_vintage-rating--box findwine_vintage-rating findwine_rating-box-' + winevintage.rating_category },
                    ' ',
                    winevintage.rating_display,
                    ' '
                  ),
                  _react2.default.createElement(
                    'div',
                    { className: 'findwine_vintage--image' },
                    _react2.default.createElement('img', { src: imageUrl, alt: winevintage.wine.name, className: 'img-fluid rounded findwine_vintage--image-img', id: 'image' })
                  ),
                  _react2.default.createElement(
                    'div',
                    { className: 'findwine_vintage-details' },
                    _react2.default.createElement(
                      'div',
                      { className: 'findwine_vintage-producer' },
                      winevintage.wine.producer
                    ),
                    _react2.default.createElement(
                      'h4',
                      { className: 'findwine_vintage-vintage', id: 'wine' },
                    ...
                    _react2.default.createElement(
                      'div',
                      { className: 'findwine_vintage-row' },
                      _react2.default.createElement(
                        'p',
                        { className: 'findwine_vintage-category' },
                        winevintage.sub_category
                      ),
                      _react2.default.createElement(
                        'div',
                        { className: 'findwine_vintage-table--display hidden-sm-up' },
                        _react2.default.createElement(
                          'div',
                          { className: 'findwine_vintage-currency' },
                          ' R '
                        ),
                        _react2.default.createElement(
                          'div',
                          { className: 'findwine_vintage-price' },
                          ' ',
                          winevintage.price,
                          ' '
                        )
                  ...
                  _react2.default.createElement(
                    'div',
                    { className: 'findwine_vintage-table--display findwine_vintage-table--display-search hidden-sm-down' },
                    _react2.default.createElement(
                      'div',
                      { className: 'findwine_vintage-currency' },
                      ' R '
                    ...
                    _react2.default.createElement(
                      'button',
                      { className: 'btn findwine_view-button',
                        href: winevintage.details_url, target: '_self',
                        role: 'button' },
                      ' View',
                      _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-right-white.svg'),
                        className: 'findwine_view-button-arrow' })
                    )
                  )
                )
              )
        ...
        return _react2.default.createElement(
          'div',
          { className: 'findwine_no-results-holder' },
          _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/no-results.svg'), className: 'findwine_no-results-holder-image' }),
          _react2.default.createElement(
            'p',
            { className: 'findwine_no-results-text-heading' },
            ' No results found. '
          ),
          _react2.default.createElement(
            'p',
            { className: 'findwine_no-results-text' },
...
var Paginator = exports.Paginator = function (_React$Component2) {
  _inherits(Paginator, _React$Component2);
  ...
  _createClass(Paginator, [{
    ...
    value: function render() {
      ...
      var nextButton = this.props.showNext ? _react2.default.createElement(
        'a',
        { className: 'btn findwine_search-next--button', href: '#top', onClick: function onClick(event) {
            return _this3.props.nextPage();
          } },
        _react2.default.createElement(
          'p',
          { className: 'findwine_search-next--button-text hidden-sm-down' },
          'Next'
        ),
        _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-right.svg'), alt: 'Next', className: 'findwine_search-next--button-arrow-right' })
      ) : _react2.default.createElement(
        'a',
        { className: 'btn findwine_search-next--button-inactive', onClick: function onClick(event) {
            return _this3.props.nextPage();
          } },
        _react2.default.createElement(
          'p',
          { className: 'findwine_search-next--button-text-inactive hidden-sm-down' },
          'Next'
        ),
        _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-right-greyLight.svg'), alt: 'Next', className: 'hidden-md-up' }),
        _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-left-green.svg'), alt: 'Next', className: 'hidden-sm-down findwine_search-next--button-green-arrow-right' })
      );
      var prevButton = this.props.showPrevious ? _react2.default.createElement(
        'a',
        { className: 'btn findwine_search-next--button findwine_search-next--button-left', href: '#top', onClick: function onClick(event) {
            return _this3.props.prevPage();
          } },
        _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-right.svg'), alt: 'Previous', className: 'findwine_search-next--button-arrow' }),
        _react2.default.createElement(
          'p',
          { className: 'findwine_search-next--button-text hidden-sm-down' },
          'Previous'
        ...
        'a',
        { className: 'btn findwine_search-next--button-inactive findwine_search-next--button-left', onClick: function onClick(event) {
            return _this3.props.nextPage();
          } },
        _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-left-grey.svg'), alt: 'Previous', className: 'hidden-md-up' }),
        _react2.default.createElement('img', { src: constructImagePath('wine/images/SVGs/arrow-left-green.svg'), alt: 'Previous', className: 'hidden-sm-down findwine_search-next--button-green-arrow' }),
        _react2.default.createElement(
          'p',
          { className: 'findwine_search-next--button-text-inactive hidden-sm-down' },
          'Previous'
      ...
      return _react2.default.createElement(
        'div',
        { className: 'findwine_search-page--container' },
        _react2.default.createElement(
          'div',
          { className: 'findwine_search-page--inner' },
          _react2.default.createElement(
            'div',
            { className: 'findwine_search-page' },
            ' Page ',
            this.props.page,
            ' '
          ),
          _react2.default.createElement(
            'div',
            { className: 'findwine_search-winesTotal' },
            ' ',
            this.props.start,
            ' - ',
            this.props.end,
        ...
        _react2.default.createElement(
          'div',
          { className: 'findwine_search-button--container' },
          prevButton,
          nextButton
        )
      );
...
var _shared = __webpack_require__(159);
...
var SearchByNamePage = function (_React$Component3) {
    _inherits(SearchByNamePage, _React$Component3);

    function SearchByNamePage() {
        _classCallCheck(this, SearchByNamePage);

        var _this4 = _possibleConstructorReturn(this, (SearchByNamePage.__proto__ || Object.getPrototypeOf(SearchByNamePage)).call(this));
    ...
    _createClass(SearchByNamePage, [{
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(SearchByNameControl, { searchText: this.state.searchText,
                    searchTextChanged: function searchTextChanged(text) {
                        return _this5.searchTextChanged(text);
                    },
                    doSearch: function doSearch() {
                        return _this5.doSearch();
                    }
                }),
        ...
        value: function doSearch() {
            ...
            fetch(SEARCH_API_URL + '?' + params).then(function (response) {
                return _this6._updateResultsFromResponse(response);
            });
        }
    }, {
        ...
        value: function prevPage() {
            ...
            if (this.state['prevPageUrl']) {
                fetch(this.state['prevPageUrl']).then(function (response) {
                    return _this9._updateResultsFromResponse(response);
                });
            }
        }
    }]);
